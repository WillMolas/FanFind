...
counter1 = 0
  ...
  location = Location.create!(
    ...
    address: ["Carrer de Zamora, 78, 08018 Barcelona", "C/ d'Ausiàs Marc, 19, 08010 Barcelona", "C/ de Trafalgar, 1, 08010 Barcelona", "C. de Fontanella, 19, 08010 Barcelona", "Carrer de Casp, 22, 08010 Barcelona", "Carrer de Milà i Fontanals, 9, 08012 Barcelona", "Carrer del Rosselló, 206, 08008 Barcelona", "C/ de Mallorca, 252, 08008 Barcelona", "C. de Villarroel, 201, 08036 Barcelona", "Av. del Paral·lel, 130, 08015 Barcelona"][counter]
  )
  2.times do
    event = Event.create!(
...
user12 = User.create!(username: "Juan LeWagon", email: "juan@email.com", password: "123456", team: "Netherlands")
...
user15 = User.create!(username: "Fransois", email: "fran@email.com", password: "123456", team: "France")
...
user37 = User.create!(username: "Philip", email: "philip@email.com", password: "123456", team: "Argentina")
...
main_match = Match.create!(team_one: "Netherlands", team_two: "Argentina", stadium: "Al bayt lusail", match_time: "8/12/2022 20:00")
